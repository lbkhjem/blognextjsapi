...
async function seedUser () {
  try {
    ...
    userToBeInserted = await dbService.findOne(model.user,{ 'username':'Hobart_Aufderhar99' });
    if (!userToBeInserted) {  
      userToBeInserted = {
        'password':'nL7wpf6J_7WgME7',
        'isDeleted':false,
        'username':'Hobart_Aufderhar99',
        'email':'Justine_Labadie10@hotmail.com',
        'isActive':true,
      ...
      await dbService.update(model.user, { 'username':'Hobart_Aufderhar99' }, userToBeInserted);
    }
    userToBeInserted = await dbService.findOne(model.user,{ 'username':'Jaycee.Miller3' });
    if (!userToBeInserted) {  
      userToBeInserted = {
        'password':'Qa6ZTQ6pZC2dUm6',
        'isDeleted':false,
        'username':'Jaycee.Miller3',
        'email':'Brianne_Williamson@hotmail.com',
        'isActive':true,
      ...
      userToBeInserted.password = await bcrypt.hash(userToBeInserted.password, 8);
      await dbService.update(model.user, { 'username':'Jaycee.Miller3' }, userToBeInserted);
    }
